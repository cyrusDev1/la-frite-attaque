<template>
  <div>
    <HeroPrivatization></HeroPrivatization>
    <Domains></Domains>
    <CallToAction></CallToAction>
    <StepTitle></StepTitle>
    <BrandIntro :presentations="presentations.slice(0, 6)"></BrandIntro>
    <ContactPrivatization></ContactPrivatization>
    <BrandIntro :presentations="presentations.slice(6)"></BrandIntro>
...
import imageFour from "~/assets/images/gallery/04.jpg";
import imageFive from "~/assets/images/gallery/07.jpg";
import imageSix from "~/assets/images/gallery/06.jpg";

import imageSeven from "~/assets/images/gallery/12.jpg";
import imageEight from "~/assets/images/gallery/13.jpg";
import imageNine from "~/assets/images/gallery/14.jpg";
